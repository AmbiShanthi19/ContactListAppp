...
public class TC_005ContactdetailsTest extends ProjectSpecificationMethods {
	...
	public void Contactdetailsreturn() throws Exception {
		...
		.clickEdit();
		EditContactPage objedit=new EditContactPage(driver);
		objedit.erasestreet1()
		.Submitedtit();
